...
public class BuscadorUF {
        ...
        public ListaUF buscarPorCapital( 
        		@WebParam(name = "busca") String busca
        		)  throws Exception {           
        ...
        @WebMethod(action = "buscarUFsPorNumeroMaiorHabitantes")
        public ListaUF buscarUFsPorNumeroMaiorHabitantes( 
        		@WebParam(name = "busca") int busca
        		)  throws Exception {           
        ...
        @WebMethod(action = "buscarUFsPorNumeroMenorHabitantes")
        public ListaUF buscarUFsPorNumeroMenorHabitantes( 
        		@WebParam(name = "busca") int busca
        		)  throws Exception {           
